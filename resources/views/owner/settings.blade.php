  ...
  <div class="col-md-7">
    <div class="card-custom mb-4">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          <small class="text-uppercase text-muted font-weight-bold" style="font-size: 10.5px; letter-spacing: 0.5px;">Subdomain Akses System</small>
        ...
        <div class="col-md-6 mb-3">
          <small class="text-uppercase text-muted font-weight-bold" style="font-size: 10.5px; letter-spacing: 0.5px;">Email Resmi Owner (Sensor Privasi)</small>
