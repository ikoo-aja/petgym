  ...
  <div class="col-lg-8">
    ...
    <div class="bg-white p-4 rounded shadow-sm">
      ...
      <form action="#" method="POST">
        @csrf
        <div class="form-group row">
          <label class="col-sm-4 col-form-name text-black font-weight-bold">Kata Sandi Saat Ini</label>
          <div class="col-sm-8">
            <input type="password" class="form-control" name="current_password">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-4 col-form-name text-black font-weight-bold">Kata Sandi Baru</label>
          <div class="col-sm-8">
            <input type="password" class="form-control" name="new_password">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-4 col-form-name text-black font-weight-bold">Konfirmasi Kata Sandi Baru</label>
          <div class="col-sm-8">
        ...
        <div class="row mt-4">
          <div class="col-sm-8 offset-sm-4">
            <button type="submit" class="btn btn-primary btn-sm px-4">Simpan Kata Sandi Baru</button>
          </div>
        </div>
      </form>
    </div>
